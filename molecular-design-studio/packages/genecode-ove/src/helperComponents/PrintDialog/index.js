...
class ReactToPrint extends React.Component {
  ...
  startPrint = () => {
    ...
    const contentNodes =
      contentEl && typeof contentEl.getDomNode === "function"
        ? contentEl.getDomNode()
        : contentEl;
    if (!contentNodes) {
      console.error("Print content DOM node is not available");
      return false;
    }
...
class ComponentToPrint extends React.Component {
  ...
  getDomNode = () => this.contentRef.current;
