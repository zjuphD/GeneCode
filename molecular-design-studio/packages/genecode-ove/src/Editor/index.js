...
export class Editor extends React.Component {
  ...
  getPanelMap = () => ({
    ...defaultPanelMap,
    // panelComponents is the explicit GeneCode extension point. Keep the
    // legacy panelMap prop last so existing integrations retain precedence.
  ...
  render() {
    ...
    const panels = flatMap(panelsToShow, (panelGroup, index) => {
      ...
      const panelMap = this.getPanelMap();
