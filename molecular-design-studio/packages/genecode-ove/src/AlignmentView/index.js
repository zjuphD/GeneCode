...
// A-ENG-001: legacy `import ReactDOM from "react-dom"` removed — the only
// ReactDOM.findDOMNode use was replaced with react-list's getEl() accessor.
                ...
                {isTemplate ? (
                  ...
                  <ReactList
                    ref={c => {
                      ...
                      // A-ENG-001: react-list exposes its own root DOM node via
                      // getEl()/el — the same node ReactDOM.findDOMNode returned,
                      // without the legacy API.
                      const domNode = c && c.getEl ? c.getEl() : c;
